/*
  # Fix Auth Policies and User Creation

  1. Changes
    - Adds safety checks for existing policies
    - Creates auth schema and users table if not exists
    - Sets up necessary indexes and constraints
    - Enables RLS policies with existence checks

  2. Security
    - Enables RLS on users table
    - Adds policies for authenticated users with safety checks
*/
