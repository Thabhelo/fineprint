/*
  # Fix Auth Schema and Role Type

  1. Changes
    - Creates auth schema and users table
    - Drops dependent policies before altering role type
    - Re-creates policies after type change
...
-- Re-create admin logs policy with new role type
...
-- Drop existing auth policies if they exist
DO $$ 
BEGIN
